       ...
       PROGRAM-ID.                PROG0010.
      *AUTHOR.                    CABARZA.
      *INSTALLATION.              BANCO DE LOS LAGOS.
      *DATE-WRITTEN.              02/08/18.
      *DATE-COMPILED.
      ...
      * -------------------------------------------------------------- *
       ...
       FILE-CONTROL.
           SELECT EMPLEADOS ASSIGN TO "G:\cobol\archivos\EMPLEADO.TXT".
           SELECT REPORTE ASSIGN TO "G:\cobol\archivos\REPORTE.TXT".
      ...
      *    DATA RECORD IS REG-REPORTE.
       ...
       01  WS-TITULO-1.
           05 FILLER              PIC X(27)    VALUES SPACES.
           05 WS-TIT-1            PIC X(22)
                                  VALUE "CENTRO DE CAPACITACION".
           05 FILLER              PIC X(31)    VALUES SPACES.
       ...
       01  WS-DETALLE-SALARIOS.
           ...
           05 FILLER              PIC X(36)    VALUES SPACES.

      * LINKAGE SECTION.
       01  LK-FECHA.
           05 FILLER              PIC X(02).
           05 LK-DIA              PIC 9(02) VALUE 03.
           05 LK-MES              PIC 9(02) VALUE 08.
           05 LK-ANIO             PIC 9(04) VALUE 2018.
